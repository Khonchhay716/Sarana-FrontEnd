...
const ResetPasswordForm: React.FC = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSCgBEK9GE7F_vCksE3O_uQdYq4eEXQFnpWOQ&s')",
      }}
    >
      {/* Overlay */}
      ...
      >
        ...
        <p className="text-sm text-gray-300 mb-6">
          Reset password for <span className="text-blue-200">{email}</span>
        </p>
