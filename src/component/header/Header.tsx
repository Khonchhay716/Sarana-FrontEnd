...
const Header = () => {
    ...
    // ✅ Call API only once — StrictMode safe
    useEffect(() => {
    ...
    const getProfileImage = () => {
        ...
        if (user.type === "Staff") {
            return user.staff?.imageProfile || "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png";
        }
        if (user.type === "Customer") {
            return user.customer?.imageProfile || "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png";
        }
        return "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png";
    };
    ...
    return (
        <nav className={`navbar px-4 w-full h-[65px] shadow-lg sticky top-0 z-40 flex justify-between items-center border-b-2 transition-all duration-300 ${darkLight
            ...
            <div className="flex items-center w-[80%] justify-end gap-2">
                ...
                {!darkLight ? (
                    <MdDarkMode onClick={() => setDarkLight(true)}
                    ...
                    <MdLightMode onClick={() => setDarkLight(false)}
