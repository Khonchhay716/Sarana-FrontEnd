...
const BookList = () => {
    ...
    const columns: TableColumnsType<Book> = [
        ...
        },
        {
            ...
            render: (_, record) => (
                <span
                    className={`px-2 py-1 rounded text-xs font-medium ${record.availableQty > 0
        ...
        },
        {
            ...
            render: (_, record) => (
                <div className="flex gap-2 justify-center">
                    <ComponentPermission scopes={["book:update"]}>
                        <button
                    ...
                    <ComponentPermission scopes={["book:delete"]}>
                        <button
    ...
    const handleOpenDeleteModal = (record: Book) => {
    ...
    const handleDeleteConfirm = async () => {
        if (idDelete !== null) {
            try {
                await DeleteData("Book", idDelete);
            ...
            <div className='flex justify-between my-2'>
                <div className='flex items-center gap-3'>
                    <div className="relative">
                        <BiBook className="w-[50px] h-[40px] drop-shadow-lg animate-bounce" />
                    </div>
                    <h3 className={`font-bold text-2xl ${darkLight ? 'text-white' : 'text-gray-900'}`}>
                        BOOK MANAGEMENT
                    </h3>
                </div>
                <ComponentPermission scopes={["book:create"]}>
                    <button
