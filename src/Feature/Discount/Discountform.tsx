                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                        ...
                        <div className={`px-4 sm:px-6 py-3 border-t flex-shrink-0 ${dl ? "border-gray-700 bg-gray-800" : "border-gray-200 bg-white"}`}>
                            <div className="flex justify-end gap-2 sm:gap-3">
                                ...
                                <ComponentPermission scopes={[discountId ? "discount:update" : "discount:create"]}>
                                    <button type="submit" disabled={loading}
                                        ...
                                        {loading ? (
                                            ...
                                            <>
                                                <span className="hidden sm:inline">{discountId ? "Update Discount" : "Create Discount"}</span>
                                                <span className="sm:hidden">{discountId ? "Update" : "Create"}</span>
                                            </>
                                        )}
                                    </button>
                                </ComponentPermission>
