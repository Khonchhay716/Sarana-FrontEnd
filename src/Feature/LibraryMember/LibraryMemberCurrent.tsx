...
import LibraryMemberCurrentForm from './LibraryFormCurrentuser';
...
const LibraryMemberListApprove = () => {
    ...
    return (
        <>
            ...
            <XDataTable
                TableName='REQUEST MEMBER'
                columns={columns}
                apiUrl='LibraryMember/CureentUser'
                selection={true}
                hideAction={true}
            ...
            {showDeleteModal && (
                <>
                    ...
                    />
                    <div
                        className={`fixed inset-0 flex items-center justify-center z-50 p-4 pointer-events-none transition-all duration-300 ${
...
export default LibraryMemberListApprove;