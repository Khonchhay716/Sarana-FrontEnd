...
type ActiveModal =
    ...
    | { type: "deleteConfirm"; staff: Staff }
    | null;
...
const StaffList = () => {
    ...
    const openDeleteModal = (staff: Staff) => {
        setActiveModal({ type: "deleteConfirm", staff });
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            await deleteImage(activeModal.staff.imageProfile);
            await DeleteData("Staff", activeModal.staff.id);
            setIsDeleteAnimating(false);
                    ...
                    <div className={`fixed inset-0 flex items-center justify-center z-50 p-4 pointer-events-none transition-all duration-300 ${isDeleteAnimating ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}>
                        <div
                            ...
                            <div className="p-6 text-center">
                                ...
                                <h3 className={`text-lg font-bold mb-2 ${dl ? "text-white" : "text-gray-900"}`}>Confirm Deletion</h3>
